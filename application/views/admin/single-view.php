                       ...
                       {
                        ?>
                        <img src="<?php echo base_url().'uploads/'.$image.'/'.$value;?>" width="150px" height="150px">
                        <?php
                       }
                       else
                       {
                       echo $value;
                        ...
                        <button type="button" class="btn btn-primary"><a href="<?php echo site_url('admin/'.$page_name.'/'.$data[0]->id);?>">Update</a></button>
