                   ...
                   <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           ...
                           <form id="add_promocode" method="POST" action="<?php echo $action;?>" data-form="ajaxform" enctype="multipart/form-data">
                              <div class="form-row">
                                 ...
                                 <label><?php echo $lbl_promo_code;?></label>
                                    <input type="text" class="form-control" placeholder="Promocode" name="promo_code" value="<?php echo $promo_code;?>">
                                 </div>
                                 <div class="col">
                                 <label><?php echo $lbl_promo_category;?></label>
                                 <select class="form-control promo_category" id="exampleFormControlSelect1" name="promo_category">
                         ...
                         <label><?php echo $lbl_no_of_usage;?></label>
                                    <input type="text" class="form-control" placeholder="Number of usage" name="no_of_usage" value="<?php echo $no_of_usage;?>">
                                 </div>
                         ...
                         <label><?php echo $lbl_min_order;?></label>
                                    <input type="text" class="form-control" placeholder="Minimum Order" name="min_order" value="<?php echo $min_order;?>">
                                 </div>
								 <div class="col">
                         <label><?php echo $lbl_max_discount;?></label>
                                    <input type="text" class="form-control" placeholder="Maximum Discount" name="max_discount" value="<?php echo $max_discount;?>">
                                 </div>
                               <!--   <div class="col">
                              ...
                              <div class="form-row" style="padding-top:50px;">
                                 ...
                                 <select name="offer_id" id="" class="m-b-10 form-control" style="width: 250px" data-placeholder="Offers" >
                           ...
                           <table class="table mb-0 table-borderless">
                             ...
                             <?php 
                              ...
                              <!--  <td>
								 ...
								 <td>
                         <span class="table-remove"><button type="button"
                                       class="btn iq-bg-danger btn-rounded btn-sm my-0"><a href="<?php echo site_url(('admin/single-view/promocode/'.$promo->id))?>">View</a></button></span>
                                       <span class="table-remove"><button type="button"
                                       class="btn iq-bg-danger btn-rounded btn-sm my-0"><a href="<?php echo site_url(('admin/update-promocode/'.$promo->id))?>">Update</a></button></span>
                                       <span class="table-remove"><input type="hidden" name="deltype" class="deltype" value="promocode">
                               ...
                               <?php $i++; }} else
                               {?>
                               <tr><td>Promocode List Not Available</td></tr>
                               <?php
                               }?>
