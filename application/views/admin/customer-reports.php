               ...
               <div class="col-lg-12">
                   <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           ...
                           <form id="customer_report" method="POST" action="" data-form="ajaxform" enctype="multipart/form-data">
                              <div class="form-row">
                                 <div class="col">
                     ...
                     <table class="table mb-0 table-borderless">
                         ...
                         <th></th>
                             ...
                             <?php 
                                 ...
                                 foreach($customerrep['customerlist'] as $index=>$value)
                                 {
                                ?>
                               <tr>
                         ...
                         <span class="table-remove"><button type="button"
                                       class="btn iq-bg-danger btn-rounded btn-sm my-0"><a href="<?php echo site_url(('admin/customer-profile/'.$value->user_id))?>">View</a></button></span>
                                 </td> 
                               </tr>
                              <?php $i++; } ?>
