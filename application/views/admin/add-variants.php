                           ...
                           <form  id="add_variants" method="POST" action="<?php echo $action;?>" data-form="ajaxform" enctype="multipart/form-data">
                              <div class="form-row">
                                  ...
                                  <label><?php echo $lbl_name;?></label>
                                    <input type="text" class="form-control" placeholder="Add Variants" name="name" value="<?php echo $name;?>">
                                 </div>
                           ...
                           <table class="table mb-0 table-borderless">
                             ...
                             <?php 
                              ...
                              <!--  <td>
								 ...
								 <td>
                         <span class="table-remove"><button type="button"
                                       class="btn iq-bg-danger btn-rounded btn-sm my-0"><a href="<?php echo site_url(('admin/single-view/variants/'.$variant->id))?>">View</a></button></span>
                                       <span class="table-remove"><button type="button"
                                       ...
                                       <span class="table-remove"><input type="hidden" name="deltype" class="deltype" value="variants">
