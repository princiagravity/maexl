		 ...
		 p
		 {
            ...
            <div class="col">
              <div class="card shadow p-3 mb-5 rounded" style="border-radius:.35rem!important; margin-bottom: 20px !important;">
                <div class="card-body">
                    <a href="<?php echo site_url('agent/order/'.$order->id)?>"><p class="card-title text-primary"><b>Order No:#<?php echo $order->order_no;?></b>&nbsp&nbsp By <a href="<?php echo site_url('agent/customer-profile/'.$order->customer_id);?>"><?php echo $order->customer;?></a></p>
