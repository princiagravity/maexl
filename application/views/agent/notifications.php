...
<div class="setting-wrapper">
    ...
    <div class="page-content-wrapper py-3">
      ...
      <div class="notification-area">
        <div class="container">
          <!-- Single Notification --><a href="page-notification-details.html">
            <div class="alert unread custom-alert-3 alert-primary" role="alert"><i class="bi bi-check2-circle mt-0"></i>
              <div class="alert-text w-75">
                <h6 class="text-truncate">Order #215 From Sreejith VS,Gravity Innovative Solutions</h6><span class="text-truncate">Gravity Innovative Solutions, United Tower, Kokkalai, Thrissur, 680541<br><br></span>
				<a class="btn btn-primary btn-sm" href="#">View the Order</a>
              </div>
            </div></a>
          <!-- Single Notification --><a href="page-notification-details.html">
            <div class="alert unread custom-alert-3 alert-primary" role="alert"><i class="bi bi-check2-circle mt-0"></i>
          ...
          <!-- Single Notification --><a href="page-notification-details.html">
            <div class="alert custom-alert-3 alert-primary" role="alert"><i class="bi bi-check2-circle mt-0"></i>
              <div class="alert-text w-75">
                <h6 class="text-truncate">Order #215 From Sreejith VS,Gravity Innovative Solutions</h6><span class="text-truncate">Gravity Innovative Solutions, United Tower, Kokkalai, Thrissur, 680541<br><br></span>
				<a class="btn btn-primary btn-sm" href="#">View the Order</a>
              </div>
