<div class="page-content-wrapper py-3">
      <div class="container">
          <?php 
          $name=$id=$user_id=$username=$email_id=$address1=$date_of_joining=$no_of_orders=$reward_amount="";
            ...
            <div class="row">
              ...
              <div class="col-6">
                ...
                <div class="single-counter-wrap text-center"><i class="bi bi-cup-fill mb-2 text-warning"></i>
                  <h4 class="mb-1 text-warning"><span class="counter"><?php echo $reward_amount;?></span>INR</h4>
        ...
        <div class="card user-data-card">
          ...
          <form id="update_profile" method="POST" action="" data-form="ajaxform" enctype="multipart/form-data" class="cart-form">
              ...
              <div class="form-group mb-3">
                ...
                <input class="form-control" id="mob_no" type="text"  placeholder="Email Address" readonly value="<?php echo $mob_no;?>">
              </div>
