<div class="page-content-wrapper py-3">
      <div class="container">
       <!--  <?php //print_r($package_detail); exit;?> -->
        <div class="card product-details-card mb-3">                   <span class="badge bg-warning text-dark position-absolute product-badge">
        
        Sale <?php  if(isset($package_detail->discount))

{  echo '-'.$package_detail->discount.' %'; }?></span>
          <div class="card-body">
            <div class="product-gallery-wrapper">
              <div class="product-gallery"><a href="<?php echo base_url().'uploads/package-images/'.$package_detail->image_url;?>"><img class="rounded" src="<?php echo base_url().'uploads/package-images/'.$package_detail->image_url;?>" alt=""></a><!-- <a href="<?php echo base_url()?>images/customer/bg-img/p2.jpg"><img class="rounded" src="<?php echo base_url()?>images/customer/bg-img/p2.jpg" alt=""></a><a href="<?php echo base_url()?>images/customer/bg-img/p3.jpg"><img class="rounded" src="<?php echo base_url()?>images/customer/bg-img/p3.jpg" alt=""></a> --></div>
            </div>
          </div>
        </div>
        <div class="card product-details-card mb-3 direction-rtl">
          <div class="card-body">
            <h3><?php echo $package_detail->name;?></h3>
            <h1 class="sale-price"><?php echo $package_detail->price; if($package_detail->mrp > $package_detail->price){?>
            <span style="text-decoration: line-through;color:#747794;font-style: italic"><?php echo $package_detail->mrp;?></span><span style="text-decoration: none;color:#747794;font-style: italic"><?php echo ' '.$package_detail->discount."% Off"?></span>
              <?php }?></h1>
            ...
            <form class="add_to_cart" method="POST" action="" data-form="ajaxform" enctype="multipart/form-data">
              ...
              <input type="hidden" id="prod_id" name="prod_id" value="<?php echo $package_detail->id; ?>">
                <input type="hidden" id="prod_name" name="prod_name" value="<?php echo $package_detail->name; ?>">
                <input type="hidden" id="price" name="price" value="<?php echo $package_detail->price;?>">
                <input type="hidden" id="mrp" name="mrp" value="<?php echo $package_detail->mrp;?>">
                <input type="hidden" id="stock" name="stock" value="<?php echo $package_detail->stock;?>">
                <input type="hidden" id="type" name="type" value="package">
              
               
              <div class="input-group">
              <input class="input-group-text form-control quantity" name="quantity" type="number" value="1" min="1" max="<?php echo  $package_detail->stock;?>">
              <?php if( $package_detail->stock <=0 ||  $package_detail->status=='Out Of Stock')
              {?>
              <button class="btn btn-danger w-50" type="button">Out Of Stock</button>
              <?php } else {?>
        ...
        <div class="card product-details-card mb-3 direction-rtl">
          <div class="card-body">
            <h5>Description</h5>
            <p><?php echo $package_detail->long_description;?></p>
        ...
        <div class="card related-product-card direction-rtl">
          <div class="card-body">
            <h5 class="mb-3">Related Packages</h5>
            <div class="row g-3">
            <?php
          
          foreach($related_package as $detail)
