      ...
      <div class="container px-0">
        ...
        <div class="footer-nav position-relative">
          <ul class="h-100 d-flex align-items-center justify-content-between ps-0">
            ...
            <li><a href="<?php echo site_url('shop-grid');?>"><!-- page-shop-grid.html -->
            ...
            <li><a href="<?php echo site_url('profile');?>"><!-- page-user-profile.html -->
            ...
            <span class="cart-count" style="min-width: 1.5rem;height: 1rem;border-radius: 50%;font-size: 1rem;margin-left: 3.2rem;color: #fff;
    background-color: #ea4c62;
" id="cart_val"><?php echo $this->session->userdata('cart_value');  ?></span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
