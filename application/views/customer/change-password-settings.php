<div class="login-wrapper d-flex align-items-center justify-content-center">
      <div class="custom-container">
        ...
        <div class="register-form mt-4">
          ...
          <form id="change-password-settings" method="POST" action="" data-form="ajaxform" enctype="multipart/form-data">
          <div class="form-group text-start mb-3 position-relative">
              <input class="form-control" id="psw-input" type="password" name="old_password" placeholder="Old password">
