   ...
   <!-- <div class="login-back-button"><a href="#">
    ...
    <div class="login-wrapper d-flex align-items-center justify-content-center">
      <div class="custom-container">
        <div class="text-center px-4"><img class="login-intro-img" src="<?php echo base_url()?>images/customer/bg-img/36.png" alt=""></div>
        <!-- Register Form -->
        ...
        <!-- Login Meta -->
        <div class="login-meta-data text-center"><a class="stretched-link forgot-password d-block mt-3 mb-1" href="<?php echo site_url('forget-password');?>">Forgot Password?</a>
        <a class="stretched-link forgot-password d-block mt-3 mb-1" href="<?php echo site_url('guest-login');?>">Guest Login</a>
